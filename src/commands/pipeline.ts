...
async function viewPipeline(
  ...
  if (!id)
    throw new AxiError(
      "Pipeline ID is required: glab-axi pipeline view <id>",
      "VALIDATION_ERROR",
    );
...
async function retryPipeline(
  ...
  if (!id)
    throw new AxiError(
      "Pipeline ID is required: glab-axi pipeline retry <id>",
      "VALIDATION_ERROR",
    );
...
async function cancelPipeline(
  ...
  if (!id)
    throw new AxiError(
      "Pipeline ID is required: glab-axi pipeline cancel <id>",
      "VALIDATION_ERROR",
    );
...
async function deletePipeline(
  ...
  if (!id)
    throw new AxiError(
      "Pipeline ID is required: glab-axi pipeline delete <id>",
      "VALIDATION_ERROR",
    );
